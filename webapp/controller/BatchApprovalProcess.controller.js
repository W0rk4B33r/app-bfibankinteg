sap.ui.define([
	...
	return Controller.extend("com.apptech.app-bankinteg.controller.BatchApprovalProcess", {
		...
		fGetAllRecord: function (queryTag) {
			var aReturnResult = [];
			$.ajax({
				url: "https://18.136.35.41:4300/app_xsjs/ExecQuery.xsjs?dbName="+ this.sDataBase +"&procName=spAppBankIntegration&QUERYTAG=getAllSavedRecord&VALUE1=&VALUE2=&VALUE3=&VALUE4=",
				type: "GET",
				async: false,
				dataType: "json",
				beforeSend: function (xhr) {
