	...
	return Controller.extend("com.apptech.app-bankinteg.controller.Main", {
	  ...
	  //ACTION BUTTON---------------------------
		  ...
		  loadUDandUDF:function(){
			...
			// //ACTIVITY LOG
			//   AppUI5.createTable("APP_ACTIVITYLOG", "Activity Log", "bott_NoObject");
			...
			// // ACTIVITY LOG
			// AppUI5.createField("App_TableAffected", "Table Affected", "@APP_ACTIVITYLOG", "db_Alpha", "", 50);
			// AppUI5.createField("App_Operation", "Operation", "@APP_ACTIVITYLOG", "db_Alpha", "", 50);
			// AppUI5.createField("App_Process", "Process", "@APP_ACTIVITYLOG", "db_Alpha", "", 50);
			// AppUI5.createField("App_ProcessBy", "Process By", "@APP_ACTIVITYLOG", "db_Alpha", "", 30);
			// AppUI5.createField("App_ProcessDate", "Process Date", "@APP_ACTIVITYLOG", "db_Alpha", "", 30);
			// AppUI5.createField("App_Status", "Status", "@APP_ACTIVITYLOG", "db_Alpha", "", 100);
		  }
